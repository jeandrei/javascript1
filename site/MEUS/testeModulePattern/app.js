 ...
 const StorageCtrl = (function(){
  ...
  return {
    storeItem: function(item){      
      let items = [];
      if(localStorage.getItem('itemls') !== null){        
        items = JSON.parse(localStorage.getItem('itemls'));
        items.push(item);
        localStorage.setItem('itemls',JSON.stringify(items));
      } else {
        items.push(item);
        localStorage.setItem('itemls',JSON.stringify(items));
      }
...
const ItemCtrl = (function(){
  ...
  return {
    ...
    addItem: function(item){
      ...
      const newItem = new Item(ID,item.name);
...
const UICtrl = (function(){
  ...
  return {
    ...
    addListItem: function(item){
      ...
      li.innerHTML = `<li id="${item.id}">${item.name}</li>`;
